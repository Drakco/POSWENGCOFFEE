...
MySQL - 5.5.5-10.4.24-MariaDB : Database - butik
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`butik` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `kategori`(`idkategori`,`namakategori`,`keterangan`,`foto`,`statusaktif`,`urisegment`) values ('KTG-000002','AKSESORIS','Aksesoris butik merujuk pada item tambahan yang digunakan untuk melengkapi tampilan dan gaya fashion','IMG_3794-2-Medium.jpg','Aktif','aksesoris'),('KTG-000003','BUTIK','Butik adalah sebuah toko ritel yang khusus menjual pakaian, aksesoris, dan produk fashion lainnya dengan fokus pada kualitas, desain, dan gaya yang unik. Butik sering kali menawarkan pilihan yang berbeda dari apa yang biasanya ditemukan di toko-toko departemen atau pusat perbelanjaan besar. Mereka menargetkan pelanggan yang mencari pakaian dan aksesoris yang lebih eksklusif, terkini, dan mungkin tidak umum.','Peluang-Bisnis-Butik-dan-Analisa-Bisnisnya-tokomesin.jpg','Aktif','butik');
...
insert  into `produk`(`idproduk`,`idkategori`,`namaproduk`,`keterangan`,`satuan`,`stok`,`stokminimum`,`hargabeli`,`hargajual`,`foto`,`statusaktif`,`qrcode`,`urisegment`) values ('PRD-000001','KTG-000003','Butik Deha','<p>Boutique Deha adalah sebuah butik fashion yang terkenal dengan koleksi pakaian olahraga dan aktivewear yang berkualitas tinggi. Deha didirikan di Italia dan telah menjadi merek yang dikenal secara global dalam industri fashion olahraga.</p>\r\n\r\n<p>Butik Deha menawarkan pakaian dan aksesori yang dirancang khusus untuk para wanita yang aktif dan peduli dengan kesehatan serta gaya hidup sehat. Produk-produk mereka menampilkan kombinasi yang sempurna antara desain yang modis dan fungsionalitas yang tinggi</p>\r\n','pcs',38,10,200000,270000,'images_(2).jpg','Aktif','KTG-000003PRD-000001','butik-deha'),('PRD-000002','KTG-000003','Butik Hijab','<p>Butik Hijab adalah toko ritel yang khusus menyediakan koleksi pakaian dan aksesoris untuk para wanita muslimah yang mengenakan hijab. Butik ini menawarkan pilihan yang luas untuk memenuhi kebutuhan dan preferensi gaya hijab yang beragam. Dalam butik ini, Anda dapat menemukan berbagai macam pakaian hijab yang modis, aksesoris yang sesuai, dan gaya yang sesuai dengan tren terkini.</p>\r\n','pcs',28,10,250000,370000,'WhatsApp-Image-2021-03-24-at-19_56_54.jpeg','Aktif','KTG-000003PRD-000002','butik-hijab'),('PRD-000003','KTG-000002','Kalung Emas Deha','<p>Kalung adalah salah satu aksesoris yang paling umum dan populer di dunia fashion. Mereka adalah perhiasan yang dikenakan di sekitar leher dan sering kali menjadi pusat perhatian dalam tampilan keseluruhan. Berikut adalah deskripsi tentang aksesoris kalung:</p>\r\n','buah',20,10,2000000,2700000,'d423fa90-18e2-41b5-ad1e-679ee4020cc7.jpg','Aktif','KTG-000002PRD-000003','kalung-emas-deha');
...
insert  into `profil_galeri`(`idgaleri`,`foto`,`keterangan`,`tglinsert`,`tglupdate`,`idpengguna`) values ('2206270001','istockphoto-1148638242-612x6123.jpg','Boutique Mona Pontianak','2022-06-27 14:12:52','2023-06-11 22:30:48','PGN-000002');
...
insert  into `profil_kontakkami`(`id`,`email`,`notelp`,`nowa`,`alamat`,`iframegoogle`,`tglupdate`,`idpengguna`) values (1,'boutiquemona@gmail.com','+6285346941654','+6285346941654','Jln. Khatulistiwa Gg. Usaha bersama 1 no 35','<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.818308983396!2d109.31259087480223!3d0.004323599995643324!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31e2a76389cc8003%3A0xab16206d244bb42b!2sGg.%20Usaha%20Bersama%201%20No.35%2C%20Batu%20Layang%2C%20Kec.%20Pontianak%20Utara%2C%20Kota%20Pontianak%2C%20Kalimantan%20Barat%2078244!5e0!3m2!1sen!2sid!4v1686497329977!5m2!1sen!2sid\" width=\"600\" height=\"450\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>','2023-06-11 22:29:51','PGN-000002');
...
insert  into `profil_slider`(`idslider`,`judul`,`keterangan`,`foto`,`url`,`statusaktif`,`tglinsert`,`tglupdate`,`idpengguna`) values ('2206270001','BENGKEL JAYA MOTOR','Jl. Adi Sucipto No.8a, Sungai Raya, Kec. Sungai Raya, Kabupaten Kubu Raya 78124','building-vehicle-motorbike-motorcycle.jpg','','Aktif','2023-06-05 09:52:46','2023-06-05 09:52:46','PGN-000002');
...
CREATE TABLE `supplier` (
  `idsupplier` char(10) CHARACTER SET latin1 NOT NULL,
  `namasupplier` varchar(100) CHARACTER SET latin1 DEFAULT NULL,
  `notelp` varchar(20) CHARACTER SET latin1 DEFAULT NULL,
  `email` varchar(50) CHARACTER SET latin1 DEFAULT NULL,
  `alamat` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `foto` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `statusaktif` enum('Aktif','Tidak Aktif') CHARACTER SET latin1 DEFAULT NULL,
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idbank_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idblog_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_iddesa_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idekspedisi_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idgaleri_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idjadwalboking_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idjadwal_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idkabupaten_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idkategori_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idkecamatan_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idlayanan_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpelanggan_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpembayaran_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpembelian_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpemesanan_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpengadaan_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idpengguna_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idperencanaansurat_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idperencanaan_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idproduk_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idreturpenjualan_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idslider_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idsosialmedia_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idsupplier_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idtarif_create`() RETURNS char(10) CHARSET utf8mb4
BEGIN
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idtestimoni_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50003 CREATE DEFINER=`root`@`localhost` FUNCTION `f_idvideo_create`(`_tgl` DATE) RETURNS char(10) CHARSET latin1
BEGIN
	DECLARE cNosekarang CHAR(4);
	DECLARE nlen INT;
	DECLARE nNoselanjutnya INT;
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_penjualan` AS select `z`.`idpenjualan` AS `idpenjualan`,`z`.`tglpenjualan` AS `tglpenjualan`,`z`.`keterangan` AS `keterangan`,`z`.`idpelanggan` AS `idpelanggan`,`z`.`namapelanggan` AS `namapelanggan`,`z`.`notelp` AS `notelp`,`z`.`email` AS `email`,`z`.`alamat` AS `alamat`,`z`.`kodepos` AS `kodepos`,`z`.`foto` AS `foto`,`z`.`totalharga` AS `totalharga`,`z`.`totalhargaservice` AS `totalhargaservice`,`z`.`diskon` AS `diskon`,`z`.`grandtotal` AS `grandtotal`,`z`.`qrcode` AS `qrcode`,`z`.`tglinsert` AS `tglinsert`,`z`.`tglupdate` AS `tglupdate`,`z`.`idpengguna` AS `idpengguna`,`z`.`namapengguna` AS `namapengguna` from (select `butik`.`penjualan`.`idpenjualan` AS `idpenjualan`,`butik`.`penjualan`.`tglpenjualan` AS `tglpenjualan`,`butik`.`penjualan`.`keterangan` AS `keterangan`,`butik`.`penjualan`.`idpelanggan` AS `idpelanggan`,`butik`.`pelanggan`.`namapelanggan` AS `namapelanggan`,`butik`.`pelanggan`.`notelp` AS `notelp`,`butik`.`pelanggan`.`email` AS `email`,`butik`.`pelanggan`.`alamat` AS `alamat`,`butik`.`pelanggan`.`kodepos` AS `kodepos`,`butik`.`pelanggan`.`foto` AS `foto`,(select ifnull(sum(`butik`.`penjualandetil`.`totalharga`),0) AS `totalharga` from `butik`.`penjualandetil` where `butik`.`penjualandetil`.`idpenjualan` = `butik`.`penjualan`.`idpenjualan`) AS `totalharga`,(select ifnull(sum(`butik`.`penjualandetilservice`.`harga`),0) AS `totalharga` from `butik`.`penjualandetilservice` where `butik`.`penjualandetilservice`.`idpenjualan` = `butik`.`penjualan`.`idpenjualan`) AS `totalhargaservice`,`butik`.`penjualan`.`diskon` AS `diskon`,`butik`.`penjualan`.`grandtotal` AS `grandtotal`,`butik`.`penjualan`.`qrcode` AS `qrcode`,`butik`.`penjualan`.`tglinsert` AS `tglinsert`,`butik`.`penjualan`.`tglupdate` AS `tglupdate`,`butik`.`penjualan`.`idpengguna` AS `idpengguna`,`butik`.`pengguna`.`namapengguna` AS `namapengguna` from ((`butik`.`penjualan` join `butik`.`pengguna` on(`butik`.`penjualan`.`idpengguna` = `butik`.`pengguna`.`idpengguna`)) left join `butik`.`pelanggan` on(`butik`.`penjualan`.`idpelanggan` = `butik`.`pelanggan`.`idpelanggan`))) `z` */;
