...
class " . $c . " extends CI_Controller {
    ...
    public function edit(\$primaryKey)
    {
        ...
        if (\$this->".$m."->getById(\$primaryKey)->num_rows() == 0) {
            \$pesan = '
                        <script type=\"text/javascript\">
                          Swal.fire(
                          \"Gagal !\",
...
$string .= "
            ...
            \$arr[]  = '
                        <a href=\"'.site_url( \$this->controller.'/edit/'.\$this->encrypt->encode(\$row->".$pk.") ).'\" class=\"btn btn-sm btn-warning btn-circle\" title=\"Edit Data\">
                            <i class=\"fa fa-edit\"></i>
                        </a>  
                     
                        <a href=\"'.site_url( \$this->controller.'/hapus/'.\$this->encrypt->encode(\$row->".$pk.") ).'\" class=\"btn btn-sm btn-danger btn-circle\" id=\"hapus\" title=\"Hapus Data\">
