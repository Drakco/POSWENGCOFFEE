...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/update/\$1'),'Ubah').\" | \".anchor(site_url('".$c_url."/delete/\$1'),'Hapus','onclick=\"javasciprt: return confirm(\\'Yakin hapus data ini ?\\')\"'), '$pk');
