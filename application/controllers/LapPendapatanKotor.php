...
class LapPendapatanKotor extends CI_Controller {

	public $controller   = 'LapPendapatanKotor';
    public $loadViewList = 'lappendapatankotor/list';
    public $loadViewForm = 'lappendapatankotor/form';

    public $formNameHead = 'Laporan Pendapatan Kotor';
    public $formNameData = 'Data Lapoan Pendapatan Kotor';
    public $formNameAdd  = 'Form Tambah Data';
    public $formNameEdit = 'Form Edit Data';

    public $menu = 'LapPendapatanKotor';

    public function __construct()
    {
        parent::__construct();
        $this->isLogin();
        $this->load->model('LapPendapatanKotor_model');
    }
    ...
    public function index()
    {
        ...
        $this->load->view('lappendapatankotor/form', $data);
    }
    ...
    public function cetak()
    {
        ...
        $data['data']       = $this->LapPendapatanKotor_model->getLaporan($tglAwal, $tglAkhir, $status, $idkategori, $idproduk);
        ...
        $data['dataPerusahaanDetil']	= $this->db->query("
        													...
        													")->row()->alamatlengkap;
        $this->load->view('lappendapatankotor/cetakpdf', $data);
    }

}

/* End of file LapPendapatanKotor.php */
/* Location: ./application/controllers/LapPendapatanKotor.php */