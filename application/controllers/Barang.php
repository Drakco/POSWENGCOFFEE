...
class Barang extends CI_Controller
{
    ...
    public function getData()
    {
        ...
        foreach ($data as $row) {
            ...
            $arr[] = '
                        <a href="' . site_url($this->controller . '/edit/' . $this->encrypt->encode($row->idbarang)) . '" class="btn btn-xs btn-warning btn-circle" title="Edit Data">
                            <i class="fa fa-edit"></i>
                        </a>

                        <a href="' . site_url($this->controller . '/hapus/' . $this->encrypt->encode($row->idbarang)) . '" class="btn btn-xs btn-danger btn-circle" id="hapus" title="Hapus Data">
