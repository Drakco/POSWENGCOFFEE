                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Slider</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idslider" id="idslider"
                                ...
                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">URL Blog (Read
                                        More)</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="url" id="url"
                                            placeholder="URL Blog (Read More)"></textarea>
                                    </div>
                                </div>
