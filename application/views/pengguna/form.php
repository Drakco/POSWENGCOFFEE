						...
						<div class="card">
							<div class="card-body">
								...
								<div class="form-group row">
									...
									<div class="col-sm-9">
										<input type="text" class="form-control" name="idpengguna" id="idpengguna"
								...
								<div class="form-group row required">
									<label for="inputPassword" class="col-sm-3 col-form-label">Level Akses</label>
									<div class="col-sm-9">
		...
		$('#form').bootstrapValidator({
			...
			fields: {
				...
				namapengguna: {
					validators: {
						notEmpty: {
							message: "<span style='color:red;'>namapengguna tidak boleh kosong</span>"
						},
					}
				},
				notelp: {
				...
				level: {
					validators: {
						notEmpty: {
							message: "<span style='color:red;'>level tidak boleh kosong</span>"
						},
					}
				},
				foto: {
