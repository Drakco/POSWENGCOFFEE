						...
						<table class="table table-striped" id="table">
							<thead>
								<tr>
									...
									<th style="width: 10%; text-align: center;">ID. Barang <br> Masuk</th>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div class="form-group row">
						<label for="staticEmail" class="col-sm-3 col-form-label">ID. Barang Masuk</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" name="idbarangmasuk" id="idbarangmasuk" readonly="">
						</div>
					</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		var level = "<?php $level = $this->session->userdata('level'); ?>";
		var v_columnDefs = [{
				"targets": [0],
				"orderable": false,
	...
	$('#table').on('click', '#uploadStruk', function() {
		var idbarangmasuk = $(this).attr("data-idbarangmasuk");
		var file_lama = $(this).attr("data-foto");

		$('#idbarangmasuk').val(idbarangmasuk);
