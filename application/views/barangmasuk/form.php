              ...
              <div class="card-body row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="staticEmail" class="col-form-label">ID. Barang Masuk</label>
                    <div class="">
                      <input type="text" class="form-control" name="idbarangmasuk" id="idbarangmasuk" placeholder="Kode Otomatis Generate" readonly="">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-6">
                  <div class="form-group required">
                    ...
                    <div class="">
                      <input type="date" class="form-control" name="tglbarangmasuk" id="tglbarangmasuk" placeholder="tglbarangmasuk" <?php echo ($readonly) ?>>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12">
                  <br>
                  <h4 class="text-center">Detil Barang Masuk</h4>
                  <hr>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    if (primaryKey != "") {
      ...
      $.ajax({
        ...
        success: function(result) {
          ...
          $("#idbarangmasuk").val(result.idbarangmasuk);

          $("#tglbarangmasuk").val(result.tglbarangmasuk);
      ...
      $("#tglbarangmasuk").val("<?php echo (date('Y-m-d')) ?>");
    }
    ...
    table = $('#table').DataTable({
      ...
      "bInfo": false,
      "ajax": {
        "url": "<?php echo site_url('Barangmasuk/datatablesourcedetail') ?>",
        "dataType": "json",
        "type": "POST",
        "data": {
          "idbarangmasuk": '<?php echo ($primaryKey) ?>'
        }
      },
    ...
    $('#form').bootstrapValidator({
      ...
      fields: {
        ...
        tglbarangmasuk: {
          validators: {
            notEmpty: {
              message: "<span style='color:red;'>tglbarangmasuk tidak boleh kosong</span>"
            },
          }
        },
        nostruk: {
      ...
      var idbarangmasuk = $('#idbarangmasuk').val();
      var tglbarangmasuk = $('#tglbarangmasuk').val();
      ...
      $.ajax({
        url: "<?php echo (site_url('Barangmasuk/simpan')) ?>",
        type: "POST",
        dataType: "JSON",
        data: formData,
        success: function(result) {
          ...
          if (result.success) {
            ...
            setTimeout(function() {
              window.location.href = "<?php echo (site_url('Barangmasuk')); ?>";
            }, 2000);
          } else {
    ...
    $('#tambahkan').click(function(event) {
      ...
      $.ajax({
        url: "<?php echo (site_url('Barangmasuk/getBarang')) ?>",
        type: "POST",
        dataType: "JSON",
        data: {
          'idbarang': idbarang,
