...
<head>
    ...
    .sidebar-light-primary .nav-sidebar>.nav-item>.nav-link.active {
		...
		body {
			background-image: url("<?php echo base_url('images/backgrd.png') ?>") !important;
		...
		<div class="content-wrapper">
			<div class="content-header">
				<div class="container">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"> DAFTAR PRODUK <small>(Makanan & Minuman)</small></h1>
						</div>
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="<?php echo site_url('DaftarProduk') ?>">Daftar Produk</a></li>
							</ol>
						</div>
					</div>
				</div>
			...
			<div class="content">
				<div class="container">
					...
					<div class="row">
						...
						<?php
						$query = $this->db->query("SELECT * FROM katalog WHERE statusaktif='Aktif' ORDER BY nama");
						if ($query->num_rows() > 0) {
							foreach ($query->result() as $row) { ?>
								<div class="col-md-4">
									<div class="card">
										<img class="card-img-top" src="<?php echo base_url('uploads/' . $row->foto) ?>" alt="Card image cap">
