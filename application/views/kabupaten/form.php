                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Kabupaten</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idkabupaten" id="idkabupaten"
                                            placeholder="Kode Otomatis Generate" readonly="">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Nama Kabupaten</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="namakabupaten" id="namakabupaten"
                                            placeholder="Nama Kabupaten">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Tarif Kabupaten
                                        (Rp.)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control money" name="tarifkabupaten"
                                            id="tarifkabupaten" placeholder="Tarif Kabupaten (Rp.)">
                                    </div>
                                </div>
                            </div>
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#namakabupaten").val(result.namakabupaten);
                $("#tarifkabupaten").val(result.tarifkabupaten);
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            namakabupaten: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>namakabupaten tidak boleh kosong</span>"
                    },
                }
            },
            tarifkabupaten: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>tarifkabupaten tidak boleh kosong</span>"
                    },
                }
            },
        }
