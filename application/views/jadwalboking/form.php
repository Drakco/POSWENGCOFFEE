                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">idjadwalboking</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idjadwalboking"
                                            id="idjadwalboking" placeholder="Kode Otomatis Generate" readonly="">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">tgljadwalboking</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="tgljadwalboking"
                                            id="tgljadwalboking" placeholder="tgljadwalboking">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">idjadwal</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idjadwal" id="idjadwal"
                                            placeholder="idjadwal">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">idpelanggan</label>
                                    <div class="col-sm-9">
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#idjadwalboking").val(result.idjadwalboking);

                $("#tgljadwalboking").val(result.tgljadwalboking);
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            tgljadwalboking: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>tgljadwalboking tidak boleh kosong</span>"
                    },
                }
            },
            idjadwal: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>idjadwal tidak boleh kosong</span>"
                    },
                }
            },
            idpelanggan: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>idpelanggan tidak boleh kosong</span>"
                    },
                }
            },
            keterangan: {
            ...
            status: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>status tidak boleh kosong</span>"
                    },
                }
            },
        }
