					...
					<div class="card">
											...
											<div class="card">
												<div class="card-body">
													<div class="form-group row">
														...
														<div class="col-sm-8">
															<input type="hidden" id="totalpembayaran" value="<?php echo $dataId->grandtotal; ?>">
													...
													<div class="form-group row">
														<label for="inputPassword" class="col-sm-4 col-form-label">Kembalian</label>
														<div class="col-sm-8">
						...
						<div class="card-footer">
							<a href="javascript:void(0)" id="simpanPembayaran"
								class="btn btn-success float-right mr-1 ml-1" id="konfirmasi"><i class="fa fa-check"></i> Proses Pembayaran</a>
							<a href="<?php echo (site_url($controller . '/list')) ?>"
...
<script type="text/javascript">
	...
	$('#simpanPembayaran').click(function() {
		...
		var totalpembayaran = untitik($('#totalpembayaran').val());
		var pembayaran = untitik($('#pembayaran').val());
		var kembalian = untitik($('#kembalian').val());

		if (totalpembayaran > pembayaran) {
			Swal.fire(
				"Informasi",
				"Total Harga Kurang dari Pembayaran",
				"info"
			);
			return false;
		}
		...
		$.ajax({
			url: "<?php echo (site_url('Penjualan/updateBayarTunai')) ?>",
			type: "POST",
			dataType: "JSON",
			data: {
