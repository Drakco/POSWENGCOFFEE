                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Desa</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row required">
                                    ...
                                    <div class="col-sm-9">
                                        <select name="idkecamatan" id="idkecamatan" class="form-control">
                                            ...
                                            <?php 
                              $queryKecamatan = $this->db->query("SELECT * FROM kecamatan WHERE statusaktif='Aktif' ORDER BY namakecamatan");
                              if ($queryKecamatan->num_rows() > 0) {
                                foreach ($queryKecamatan->result() as $rowKecamatan) { ?>
                                            <option value="<?php echo $rowKecamatan->idkecamatan; ?>">
                                                <?php echo $rowKecamatan->namakecamatan; ?></option>
                                            <?php
                                }
                              }
                              ?>
                                ...
                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Nama Desa</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="namadesa" id="namadesa"
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#iddesa").val(result.iddesa);

                $("#idkecamatan").val(result.idkecamatan);
                $("#namadesa").val(result.namadesa);
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            idkecamatan: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>idkecamatan tidak boleh kosong</span>"
                    },
                }
            },
            namadesa: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>namadesa tidak boleh kosong</span>"
                    },
                }
            },
        }
