                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Kategori</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idkategori" id="idkategori"
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            namakategori: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>namakategori tidak boleh kosong</span>"
                    },
                }
            },
            keterangan: {
