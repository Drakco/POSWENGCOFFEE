                    ...
                    <form id="form">
                            ...
                            <div class="card-body row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="staticEmail" class="col-form-label">ID. Pengadaan</label>
                                        <div class="">
                                            <input type="text" class="form-control" name="idpengadaan" id="idpengadaan"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group required">
                                        <label for="inputPassword" class="col-form-label">Tgl.
                                            Pengadaan</label>
                                        <div class="">
                                            <input type="date" class="form-control" name="tglpengadaan"
                                                id="tglpengadaan" placeholder="tglpengadaan">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <br>
                                    <h4 class="text-center">Detil Pengadaan</h4>
                                    <hr>
                                </div>
                        ...
                        if ($queryProduk->num_rows() > 0) {
                          foreach ($queryProduk->result() as $rowProduk) { ?>
                                                <option value="<?php echo ($rowProduk->idproduk) ?>">
                                                    <?php echo ($rowProduk->namaproduk . ' / ' . $rowProduk->satuan) ?>
                                                </option>
                                                <?php
                          }
                        }
                        ?>
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <div class="">
                                            <input type="text" class="form-control money" name="qty" id="qty"
                                                placeholder="0">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col">
                                    <a href="javascript:void(0)" class="btn btn-info" style="margin-top: 36px;"
                                        id="tambahkan">
                                    ...
                                    <div class="table-responsive">
                                        <table id="table" class="display" style="width: 100%; font-size: 15px;">
                                            ...
                                            <tfoot>
                                                ...
                                                <th></th>
                                                <th></th>
                                                <th style="text-align: right; font-weight: bold; font-size: 15px;">Total
                                                    : </th>
...
?>
    ...
    $(document).ready(function() {
        ...
        if (primaryKey != "") {
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    $("#idpengadaan").val(result.idpengadaan);

                    $("#tglpengadaan").val(result.tglpengadaan);
            ...
            $('#tglpengadaan').val("<?php echo date('Y-m-d') ?>");
        }
        ...
        table = $('#table').DataTable({
            ...
            "bInfo": false,
            "ajax": {
                "url": "<?php echo site_url('Pengadaan/datatablesourcedetail') ?>",
                "dataType": "json",
                "type": "POST",
                "data": {
                    "idpengadaan": '<?php echo ($primaryKey) ?>'
                }
            },
        ...
        $('#tambahkan').click(function(event) {
            ...
            $.ajax({
                url: "<?php echo (site_url('Pengadaan/getProduk')) ?>",
                type: "POST",
                dataType: "JSON",
                data: {
                    'idproduk': idproduk,
        ...
        $('#form').bootstrapValidator({
            ...
            fields: {
                ...
                tglpengadaan: {
                    validators: {
                        notEmpty: {
                            message: "<span style='color:red;'>tglpengadaan tidak boleh kosong</span>"
                        },
                    }
                },
                idsupplier: {
                    validators: {
                        notEmpty: {
                            message: "<span style='color:red;'>idsupplier tidak boleh kosong</span>"
                        },
                    }
                },
                keterangan: {
            ...
            var idpengadaan = $('#idpengadaan').val();
            ...
            $.ajax({
                url: "<?php echo (site_url('Pengadaan/simpan')) ?>",
                type: "POST",
                dataType: "JSON",
                data: formData,
                success: function(result) {
