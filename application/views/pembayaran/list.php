        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped" id="tablePembayaran"  style="font-size: 11px;">
                        <thead style="!important; vertical-align: middle;">
                            <tr>
                                <th style="width: 5%; text-align: center;">No</th>
                                <th style="text-align: center;">ID. Pembayaran /<br>Tgl. Pembayaran</th>
                                <th style="text-align: center;">ID. Pemesanan /<br>Tgl. Pemesanan</th>
                                <th style="text-align: center;">Pelanggan</th>
                                <th style="text-align: center;">Total Harga</th>
                                <th style="text-align: center;">Metode</th>
                                <th style="text-align: center;">Bank</th>
                                <th style="text-align: center;">Jumlah<br>Pembayaran</th>
                                <th style="text-align: center;">Status</th>
                                <th style="text-align: center;">Konfirmasi</th>
                                <th style="width: 10%; text-align: center;">Aksi</th>
                            </tr>
                        </thead>
                        <tbody style="!important; vertical-align: middle;">
