        ...
        <div class="container-fluid">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-4">
                        <select name="statusperencanaan" id="statusperencanaan" class="form-control">
                            <option value="0">SEMUA STATUS PERENCANAAN</option>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#btnCetakPdf').click(function() {
            ...
            var statusperencanaan = $('#statusperencanaan').val();

            window.open("<?php echo site_url('LapPerencanaanBisnis/cetak/') ?>" + tglawal + '/' + tglakhir + '/' + statusperencanaan + '/Laporan Perencanaan Bisnis', '_blank');
