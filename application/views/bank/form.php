                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Bank</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idbank" id="idbank"
                                ...
                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Atas Nama</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="atasnama" id="atasnama"
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            namabank: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>namabank tidak boleh kosong</span>"
                    },
                }
            },
            atasnama: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>atasnama tidak boleh kosong</span>"
                    },
                }
            },
            norekening: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>norekening tidak boleh kosong</span>"
                    },
                }
            },
            keterangan: {
