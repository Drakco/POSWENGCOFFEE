                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-4">
                        <select name="statuskonfirmasi" id="statuskonfirmasi" class="form-control">
                            <option value="3">Semua Status Konfirmasi</option>
...
$(document).ready(function() {
    ...
    $('#btnCetakPdf').click(function() {
        ...
        window.open("<?php echo site_url('LapPemesanan/cetak/') ?>" + tglawal + '/' + tglakhir + '/' +
            statuskonfirmasi + '/Laporan Konfirmasi', '_blank');
