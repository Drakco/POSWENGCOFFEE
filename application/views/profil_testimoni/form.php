                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Testimoni</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idtestimoni" id="idtestimoni"
                                            placeholder="Kode Otomatis Generate" readonly="">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Tgl. Testimoni</label>
                                    <div class="col-sm-9">
                                        <input type="date" class="form-control" name="tgltestimoni" id="tgltestimoni"
                                            placeholder="Tgl. Testimoni">
                                    </div>
                                </div>
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#idtestimoni").val(result.idtestimoni);

                $("#tgltestimoni").val(result.tgltestimoni);
        ...
        $('#tgltestimoni').val("<?php echo date('Y-m-d'); ?>");
    }
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            tgltestimoni: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>tgltestimoni tidak boleh kosong</span>"
                    },
                }
            },
            keterangan: {
