                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Tarif</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idtarif" id="idtarif"
                                            placeholder="Kode Otomatis Generate" readonly="">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Nama Tarif</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Tarif (Rp.)</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control money" name="tarif" id="tarif"
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#idtarif").val(result.idtarif);

                $("#namatarif").val(result.namatarif);
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            namatarif: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>namatarif tidak boleh kosong</span>"
                    },
                }
            },
            tarif: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>tarif tidak boleh kosong</span>"
                    },
                }
            },
            keterangan: {
