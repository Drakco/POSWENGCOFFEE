                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="staticEmail" class="col-sm-3 col-form-label">ID. Sosial Media</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="idsosialmedia" id="idsosialmedia"
                                            placeholder="Kode Otomatis Generate" readonly="">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">Nama Sosial Media</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="nama_sosialmedia"
                                            id="nama_sosialmedia" placeholder="Nama Sosial Media">
                                    </div>
                                </div>

                                <div class="form-group row required">
                                    <label for="inputPassword" class="col-sm-3 col-form-label">URL Sosail Media</label>
                                    <div class="col-sm-9">
                                        <textarea type="text" class="form-control" name="url" id="url"
                                            placeholder="URL Sosail Media"></textarea>
                                    </div>
                                </div>
    ...
    if (primaryKey != "") {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                $("#idsosialmedia").val(result.idsosialmedia);

                $("#nama_sosialmedia").val(result.nama_sosialmedia);
                $("#url").val(result.url);
    ...
    $('#form').bootstrapValidator({
        ...
        fields: {
            ...
            nama_sosialmedia: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>nama_sosialmedia tidak boleh kosong</span>"
                    },
                }
            },
            url: {
                validators: {
                    notEmpty: {
                        message: "<span style='color:red;'>url tidak boleh kosong</span>"
                    },
                }
            },
        }
