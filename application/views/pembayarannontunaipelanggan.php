		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
					<h2 class="text-center display-4">CARI PEMBAYARAN</h2>
					<div class="row">
						<div class="col-md-8 offset-md-2">
							<form action="<?php echo site_url('PembayaranNonTunaiPelanggan/detil') ?>" method="POST">
								<div class="input-group">
									<select name="idpenjualan" class="form-control form-control-lg">
										<option value="">PILIH PEMBAYARAN</option>
										<?php
										$queryPembayaran = $this->db->query("SELECT * FROM v_penjualan WHERE statuspembayaran='Belum Bayar' ");
										if ($queryPembayaran->num_rows() > 0) {
											foreach ($queryPembayaran->result() as $rowPembayaran) { ?>
												<option value="<?php echo $rowPembayaran->idpenjualan; ?>"><?php echo $rowPembayaran->keterangan; ?></option>
										<?php
											}
										}
										?>
