...
class Profil_model extends CI_Model {
    ...
    var $column_order = array(null, 'id','namaperusahaan','tentangkami','logoperusahaan','fotoperusahaan','tglupdate','idpengguna' );
    var $column_search = array('id','namaperusahaan','tentangkami','logoperusahaan','fotoperusahaan','tglupdate','idpengguna');
