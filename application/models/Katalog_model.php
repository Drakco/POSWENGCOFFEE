...
class Katalog_model extends CI_Model
{
	...
	var $column_order = array(null, 'id', 'nama', 'foto', 'statusaktif');
	var $column_search = array('id', 'nama', 'foto', 'statusaktif');
...
/* End of file Katalog_model.php */
/* Location: ./application/models/Katalog_model.php */
