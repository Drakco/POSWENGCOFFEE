...
class Kabupaten_model extends CI_Model {
    ...
    var $table             = 'kabupaten';
    var $pK_table          = 'idkabupaten';   
    var $v_table           = 'kabupaten';

    var $column_order = array(null, 'idkabupaten','namakabupaten','tarifkabupaten','statusaktif' );
    var $column_search = array('idkabupaten','namakabupaten','tarifkabupaten','statusaktif');
    var $order = array('idkabupaten' => 'asc'); // default order 
