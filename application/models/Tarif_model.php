...
class Tarif_model extends CI_Model {
    ...
    var $table             = 'tarif';
    var $pK_table          = 'idtarif';   
    var $v_table           = 'tarif';

    var $column_order = array(null, 'idtarif','namatarif','tarif','keterangan','statusaktif' );
    var $column_search = array('idtarif','namatarif','tarif','keterangan','statusaktif');
    var $order = array('idtarif' => 'asc'); // default order 
