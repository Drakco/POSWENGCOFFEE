...
class Bank_model extends CI_Model {
    ...
    var $column_order = array(null, 'idbank','namabank','atasnama','norekening','keterangan','foto','statusaktif' );
    var $column_search = array('idbank','namabank','atasnama','norekening','keterangan','foto','statusaktif');
    var $order = array('idbank' => 'asc'); // default order 
