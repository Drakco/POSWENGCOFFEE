...
class Jenis_model extends CI_Model {
    ...
    var $table             = 'jenis';
    var $pK_table          = 'idjenis';   
    var $v_table           = 'jenis';

    var $column_order = array(null, 'idjenis','nama','keterangan' );
    var $column_search = array('idjenis','nama','keterangan');
    var $order = array('idjenis' => 'asc'); // default order 
