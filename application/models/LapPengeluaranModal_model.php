...
class LapPengeluaranModal_model extends CI_Model {
	...
	public function getLaporan($tglAwal, $tglAkhir, $status, $idkategori, $idproduk)
	{
		...
		$strSQL = "
			...
			WHERE 
				...
				$filter
			GROUP BY `v_penjualandetil_global`.`id`,`v_penjualandetil_global`.`status`
...
/* End of file LapPengeluaranModal_model.php */
/* Location: ./application/models/LapPengeluaranModal_model.php */